...
export async function runLoadPeopleStream({
  ...
  // Event-driven progress is leading-edge throttled and is not called during
  // transform steps, so a heartbeat is required or the marker stays at the
  // initial "pipeline-configured" zeros while batches keep running.
