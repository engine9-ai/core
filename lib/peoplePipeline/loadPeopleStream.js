...
export async function runLoadPeopleStream({
  ...
  function formatLoadPeopleProgressMessage() {
    ...
    return `loadPeople${table}: ${completed} records completed (${completedRate}/s)${pendingPart}, ${sourced} sourced (${sourceRate}/s), sql batches ${sqlBatchIndex}, stage: ${stageDetail}`;
  }
