/*
  ...
  Used by e9core sqlite-ddl (--stack) so a site can print CREATE statements
  without the server PluginWorker. Live install, exclude enforcement, and
  schema deploy live on @engine9/server.
*/
...
/**
 * Load include/exclude metadata for a plugin path. Prefers a local
