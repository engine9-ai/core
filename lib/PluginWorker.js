...
PluginWorker.prototype.install.metadata = {
  options: {
    path: {
      description:
        'Plugin package identity (@engine9/interfaces/..., @engine9/plugins/...) or shorthand resolved via a host-provided listAvailable catalog (e.g. transaction/contact_details, e9email). Legacy local$ prefix is accepted and stripped. Defaults to the account default stack.'
    },
    source: {
      description:
